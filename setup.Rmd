...
remotes::install_github("tbep-tech/pepreporting")
```
...
Download the zipped file of all the data from this [link](data/data.zip).  Place this zipped folder in a location on your computer that you can access for the workshop. There is no need to unzip the folder.
