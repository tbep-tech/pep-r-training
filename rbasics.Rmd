...
remotes::install_github("remotes/pepreporting")
    ```
...
In this lesson we learned about R and Rstudio, some of the basic syntax and data structures in R, and how to import files.  We've just imported some water quality and pathogen data from the Peconic Estuary that we'll continue to use for the rest of the workshop.  Next we'll learn how to process and plot these data using the pepreporting R package.
