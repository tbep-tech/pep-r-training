...
- [pepreporting overview]
- [Basic use]
- [Plotting]

## Goals and motivation

This module will provide you with background into the structure of the pepreporting R package and how to use functions in this package read, anaalyze, and plot water quality data indicators for the Peconic Estuary Program. You should be able to answer these questions at the end of this session:

* What is the pepreporting package and how are the functions setup?
* How can I use the pepreporting package to import water quality data? 
...
The pepreporting package was developed as a set of functions to read, analyze, and plot water quality data relevant for the PEP.  the package source code lives on [GitHub](https://github.com/tbep-tech/pepreporting) and a [website](https://tbep-tech.github.io/pepreporting/) that includes function references and full documentation is also provided. The following shows all functions provided in pepreporting, organized by prefix. 
...
Before we use the package, we'll load it into our current R session as follows.  You should have already installed the package in the previous lesson. 
