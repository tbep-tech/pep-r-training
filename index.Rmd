...
This course is designed to expose you to the fundamentals of using R for working with the [peptools](https://tbep-tech.github.io/peptools/index.html) R package.  We will also cover the basics of using R if you are not familiar with the software. You will not be R experts by the end of the course, but you will have a solid foundation for continued learning.  By the end of this course you will be able to or have the resources to find out how to:
