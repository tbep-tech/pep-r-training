...
To use Rstudio Cloud, copy this link and paste it in a web browser: <https://rstudio.cloud/project/2193924> 
...
This project includes all of the files for the course website, so there is a lot of stuff. For each training module, you'll want to pull up the appropriate R script to follow along (e.g., `rbasics.R`).
